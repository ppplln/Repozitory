...
class ServiceSubscription:
    """Класс, описывающий цифровую подписку (нематериальный объект)."""
    ...
    def upgrade_plan(self, new_plan: str, new_fee: float) -> str:
        ...
        # Валидация: новая цена должна быть выше текущей
...
class DigitalBook:
    ...
    def turn_page(self, forward: bool = True) -> int:
        ...
        # Валидация: страница не может выйти за пределы книги
